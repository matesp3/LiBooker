...
namespace LiBookerWebApi.Services
{
    public class SampleBackgroundWorker : BackgroundService
    {
        ...
        public SampleBackgroundWorker(IDbContextFactory<AppDbContext> dbFactory) => this.dbFactory = dbFactory;
    ...
    public class ParallelProcessor
    {
        ...
        public ParallelProcessor(IDbContextFactory<AppDbContext> dbFactory) => this.dbFactory = dbFactory;
